...
class InfisicalIntegrationTester {
  ...
  private async testEnvironmentVariables(): Promise<void> {
    await this.runTest('Environment variables are set', async () => {
      const requiredVars = [
        'INFISICAL_CLIENT_ID',
  ...
  private async testAuthentication(): Promise<void> {
    await this.runTest('Universal Auth login succeeds', async () => {
  ...
  private async testCreateSecret(): Promise<void> {
    ...
    await this.runTest('Create secret succeeds (write-only)', async () => {
      // Create folder first
  ...
  private async testDuplicateSecretHandling(): Promise<void> {
    ...
    await this.runTest('Duplicate secret gets timestamp suffix', async () => {
      // Create folder first
      await createFolder(`/${testOrgSlug}`);
  ...
  private async testFullDepositFlow(): Promise<void> {
    ...
    await this.runTest('Full deposit flow with all secret types', async () => {
      // Create folder first
      await createFolder(`/${testOrgSlug}`);
  ...
  private async testPartialDeposit(): Promise<void> {
    ...
    await this.runTest('Partial deposit with only URL', async () => {
      // Create folder first
      await createFolder(`/${testOrgSlug}`);
  ...
  private async testSecretPathValidation(): Promise<void> {
    await this.runTest('Secret path format validation', async () => {
      const testOrgSlug = `acme-corp-${Date.now()}`;
  ...
  private async testSecretNamingConvention(): Promise<void> {
    ...
    await this.runTest('Secret naming follows APPNAME_FIELD pattern', async () => {
      // Create folder first
      await createFolder(`/${testOrgSlug}`);
